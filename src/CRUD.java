    ...
    public static void main(String[] args) {
        ...
        switch(menuAlumno){
            ...
            case 2:
                ...
                System.out.println("=============================================");
                System.out.println("11. Datos de un alumno en un periodo escolar");
                System.out.println("12. Grupos en los que ha estado un alumno");
                System.out.println("13. Números de teléfono de un tutor");
                System.out.println("14. Inscripciones pagadas de un alumno");
                System.out.println("15. Mensualidades pagadas de un alumno en un periodo escolar");
                System.out.println("16. Pagos realizados por un evento especial");
                System.out.println("17. Costos del mantenimiento por periodo escolar");
                System.out.println("18. Lista de precios de los paquetes de útiles escolares (papelería) para un periodo y nivel escolar.");
                System.out.println("19. Lista de precios de los uniformes para un para un periodo y nivel escolar.");
                System.out.println("20. Total de pagos realizados para un nivel educativo en un periodo escolar");
                System.out.println("-------------------------------");
